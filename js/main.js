...
/***/ "./src/js/components/swiper-bundle.min.js":
/*!************************************************!*\
  !*** ./src/js/components/swiper-bundle.min.js ***!
  \************************************************/
...
/* harmony import */ var _components_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/swiper-bundle.min */ "./src/js/components/swiper-bundle.min.js");
/* harmony import */ var _components_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_3__);
var _Swiper;
...
(function () {
  ...
  var enableSwiper = function enableSwiper() {
    mySwiper = new (_components_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_3___default())('.gallery-swiper', {
      slidesPerView: 1,
      simulateTouch: false,
      watchOverflow: true,
...
var homeSlider = new (_components_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_3___default())('.home-swiper', (_Swiper = {
  simulateTouch: false,
  watchOverflow: true,
  slidesPerView: 1,
  effect: 'fade',
  ...
  forceToAxis: true
}), _defineProperty(_Swiper, "keyboard", false), _defineProperty(_Swiper, "navigation", {
  nextEl: '#next--intro',
  prevEl: '#prev--intro'
}), _defineProperty(_Swiper, "keyboard", false), _Swiper));
var stagesSwiper = new (_components_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_3___default())('.stages-swiper', {
  slidesPerView: 5,
  simulateTouch: false,
  watchOverflow: true,
  watchSlidesVisibility: true,
...
var worksSwiper = new (_components_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_3___default())('.works-swiper', {
  simulateTouch: false,
  watchOverflow: true,
  watchSlidesVisibility: true,
  cssMode: false,
...
Fancybox.bind("[data-fancybox]", {}); // Scroll to anchors

(function () {
  document.querySelectorAll('a[href^="#"]').forEach(function (elem) {
    elem.addEventListener('click', function (e) {
      e.preventDefault();
      var block = document.querySelector(elem.getAttribute('href')),
